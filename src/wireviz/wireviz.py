        ...
        for entry in conduit_connection_set:
            for item in entry:
                ...
                if designator in harness.connectors:  # existing connector instance
                    ...
                    check_type(designator, template, "cable/arrow")
                    harness.add_conduit(
                        designator=designator, **template_conduits[template]
                    )
            ...
            for index_item, item in enumerate(entry):
                ...
                if designator in harness.cables:
                    ...
                    cable_conduits = [
                        ...
                        if designator in getattr(conduit, "cables", [])
                    ]

                    conduits = []
                    next_from_connector = from_name
                    while cable_conduits:
                        ...
                        for conduit_connection_set in conduit_connection_sets:
                            ...
                            if conduit_from == next_from_connector:
                                ...
                                break
                        if not matched:
                            # No matching conduit path found; avoid infinite loop
                            break
